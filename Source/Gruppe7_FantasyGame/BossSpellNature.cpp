...
// Sets default values
ABossSpellNature::ABossSpellNature()
{
	...
	CollisionComponent->OnComponentHit.AddDynamic(this, &ABossSpellNature::OnHit);
	...
	ProjectileMovementComponent->OnProjectileStop.AddDynamic(this, &ABossSpellNature::OnStop);
}

// Called when the game starts or when spawned
void ABossSpellNature::BeginPlay()
{
	Super::BeginPlay();
}

// Called every frame
void ABossSpellNature::Tick(float DeltaTime)
{
...
void ABossSpellNature::UpdateTarget()
{
...
void ABossSpellNature::OnStop(const FHitResult& HitResult)
{
	//Destroy();
}

void ABossSpellNature::OnHit(UPrimitiveComponent * HitComponent, AActor * OtherActor, UPrimitiveComponent * OtherComponent, FVector NormalImpulse, const FHitResult & Hit)
{
	//Destroy();
}

void ABossSpellNature::Destroy()
{
	Super::Destroy();
